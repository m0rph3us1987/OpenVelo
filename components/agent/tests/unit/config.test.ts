...
import { CONFIG, applyHandshake, type HandshakeConfig } from '../../src/config.js';
...
describe('applyHandshake', () => {
    ...
    it('correctly sets all four CONFIG model fields', () => {
        const handshake: HandshakeConfig = {
    ...
    it('sets empty string for model fields that are null', () => {
        const handshake: HandshakeConfig = {
            repo_url: 'https://github.com/test/repo',
            backend: 'opencode',
            execution_model: null as unknown as string,
            blueprint_model: null as unknown as string,
            review_model: null as unknown as string,
            documentation_model: null as unknown as string,
            build_cmd: 'npm run build',
            test_cmd: 'npm test',
            staging_branch: 'staging',
        };

...
describe('groups routes', () => {
  ...
  describe('POST /api/groups', () => {
    it('creates group with members and projects', async () => {
      ...
      const p1 = createProject({ name: 'proj1', port: 7001, password_hash: null, repo_host: 'github', repo_url: '', repo_pat: null, docker_image: 'openvelo-agent:linux', backend: 'opencode', default_model: '', execution_model: '', blueprint_model: '', analyzer_model: '', chat_model: '', requirement_model: '', planning_model: '', review_model: '', documentation_model: '', build_cmd: null, test_cmd: null, staging_branch: 'staging', poll_interval: 60000, agent_max_timeout: 300, max_parallel_jobs: 1, max_retries: 3, agent_max_retries: 3, status: 'stopped', pid: null });

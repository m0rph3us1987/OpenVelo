...
- Check if `{REPO_DIR}/docs/index.md` exists. If it does, read it. Based on the domain area discussed in the conversation, ONLY open and read the linked domain architecture files that are relevant. Do NOT load unrelated architecture docs.

...
> **CRITICAL INSTRUCTION**: You MUST use your file reading tool to open and read the exact file path for any matched skills (e.g., `<SKILLS>/react/<skill>/SKILL.md`). Do not guess the rules. Read the actual `SKILL.md` file and apply its rules to your work.
